<template>
<div class="floating" :style="{ left: `${left}px`, top: `${top}px`, width: `${width}px`, height: `${height}px` }">
  <div class="floating-panel" :style="{ width: `${width + 10}px`, height: `${height + 10}px` }">
...
export default class Floating extends Vue {
  ...
  private init() {
    const el = this.$el.firstChild as HTMLElement;
    this.data = {
      capture: { x: 0, y: 0 },
